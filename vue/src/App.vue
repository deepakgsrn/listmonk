      ...
      >
        <div>
          <div class="logo">
            ...
            <p class="is-size-7 has-text-grey version">v0.6.2-alpha</p>
          </div>
          <b-menu :accordion="false">
            <b-menu-list>
              ...
              <b-menu-item :active="activeItem.lists" :expanded="activeGroup.lists"
              ...
              <b-menu-item :active="activeItem.subscribers" :expanded="activeGroup.subscribers"
              ...
              <b-menu-item :active="activeItem.campaigns" :expanded="activeGroup.campaigns"
