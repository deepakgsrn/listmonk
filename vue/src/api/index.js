...
export const startCampaign = async (id) => changeCampaignStatus(id, 'running');

export const scheduleCampaign = async (id) => changeCampaignStatus(id, 'scheduled');

export const pauseCampaign = async (id) => changeCampaignStatus(id, 'paused');

export const cancelCampaign = async (id) => changeCampaignStatus(id, 'cancelled');

export const draftCampaign = async (id) => changeCampaignStatus(id, 'draft');
