    ...
    <b-table :data="campaigns.results" :hoverable="true" :loading="loading.campaigns"
      ...
      default-sort="createdAt">
        <template slot-scope="props">
            <b-table-column field="status" label="Status" width="12%" :id="props.row.id">
              <div>
                <p>
            ...
            <b-table-column field="createdAt" label="Timestamps" width="17%" sortable>
            ...
            <b-table-column :class="props.row.status" field="stats" label="Stats" width="18%">
...
export default Vue.extend({
  ...
  methods: {
    ...
    highlightedRow(data) {
      if (this.$route.query.id && parseInt(this.$route.query.id, 10) === data.id) {
        return 'highlight';
      }
      return '';
    },
